...
describe("Example 1 tests", () => {
    ...
    it("Can load a book collection without initial items", async () => {
    ...
    it("Can load a book collection with one initial item (number)", async function() {
        this.slow(100)
    ...
    it("Can load a book collection with one initial item (string)", async function() {
        this.slow(100)
        const collection = new BookCollection(["42"])
        const items = await collection.getAll()
        let count = 0
    ...
    it("Can load a book collection with several items", async function() {
        this.slow(100)
